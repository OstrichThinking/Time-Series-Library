...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/Transformer_noninvasive_st30_5_surgicalF_MSE_BCE.py > checkpoints/output_Transformer_noninvasive_st30_5_surgicalF_MSE_BCE.log 2>&1 &
