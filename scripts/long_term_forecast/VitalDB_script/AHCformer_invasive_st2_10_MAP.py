...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/AHCformer_invasive_st2_10_MAP.py > checkpoints/AHCformer_invasive_st2_10_MAP.log 2>&1 &
    ...
    🌞实验结果:
        ...
        |        MSE         |        MAE         |        DTW         |
        +--------------------+--------------------+--------------------+
        | 46.611759185791016 | 4.135340213775635  |   Not calculated   |
        +--------------------+--------------------+--------------------+
        分类性能比较:
        +--------------------+--------------------+--------------------+
        |        AUC         |      Accuracy      |       Recall       |
        +--------------------+--------------------+--------------------+
        |      0.92652       |      0.36646       |       0.5252       |
        +--------------------+--------------------+--------------------+
        |     Precision      |    Specificity     |         F1         |
        +--------------------+--------------------+--------------------+
        |      0.89394       |      0.99446       |      0.68046       |
        +--------------------+--------------------+--------------------+
        混淆矩阵:
        +--------------------+--------------------+--------------------+
        |         TP         |         FN         |         --         |
...
model_id = 'AHCformer_invasive_st2_10_MAP'
