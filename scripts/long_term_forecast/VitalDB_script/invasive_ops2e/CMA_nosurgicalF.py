...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/invasive_ops2e/CMA_nosurgicalF.py > checkpoints/invasive_ops2e/CMA_nosurgicalF_test.log 2>&1 &
