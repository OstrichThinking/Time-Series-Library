...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/AHCformer_invasive_st2_10_nosurgicalF_cma_ts.py > checkpoints/AHCformer_invasive_st2_10_nosurgicalF_cma_ts.log 2>&1 &
    ...
    🌞实验结果:
        ...
        |        MSE         |        MAE         |        DTW         |
        +--------------------+--------------------+--------------------+
        | 46.567230224609375 | 4.1267900466918945 |   Not calculated   |
        +--------------------+--------------------+--------------------+
        分类性能比较:
        +--------------------+--------------------+--------------------+
        |        AUC         |      Accuracy      |       Recall       |
...
model_id = 'AHCformer_invasive_st2_10_nosurgicalF_cma_ts'
