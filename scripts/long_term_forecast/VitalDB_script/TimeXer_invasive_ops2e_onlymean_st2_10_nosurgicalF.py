...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/TimeXer_invasive_ops2e_onlymean_st2_10_nosurgicalF.py > checkpoints/TimeXer_invasive_ops2e_onlymean_st2_10_nosurgicalF.log 2>&1 &
...
model_id = 'TimeXer_invasive_ops2e_onlymean_st2_10_nosurgicalF'
