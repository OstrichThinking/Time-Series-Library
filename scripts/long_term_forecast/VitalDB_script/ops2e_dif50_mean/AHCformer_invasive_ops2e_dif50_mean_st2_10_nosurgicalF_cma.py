...
"""
    ...
    🏠数据集：
        - AHCformer_invasive_ops2e_dif50_mean_st2_10_nosurgicalF_cma
        - (残差+滤波)*2 + 均值填充
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/AHCformer_invasive_ops2e_dif50_mean_st2_10_nosurgicalF_cma.py > checkpoints/AHCformer_invasive_ops2e_dif50_mean_st2_10_nosurgicalF_cma.log 2>&1 &
...
model_id = 'AHCformer_invasive_ops2e_dif50_mean_st2_10_nosurgicalF_cma'
