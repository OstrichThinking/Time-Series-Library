...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/AHCformer_invasive_st2_10_nosurgicalF_cma_ts_bp.py > checkpoints/AHCformer_invasive_st2_10_nosurgicalF_cma_ts_bp.log 2>&1 &
    ...
    🌞实验结果:
        ...
        |        MSE         |        MAE         |        DTW         |
        +--------------------+--------------------+--------------------+
        | 46.38679885864258  |  4.11467981338501  |   Not calculated   |
        +--------------------+--------------------+--------------------+
        分类性能比较:
        +--------------------+--------------------+--------------------+
        |        AUC         |      Accuracy      |       Recall       |
...
model_id = 'AHCformer_invasive_st2_10_nosurgicalF_cma_ts_bp'
