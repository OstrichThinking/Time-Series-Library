...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/Transformer_invasive_st2_ops2e_onlymean_nosurgicalF.py > checkpoints/output_Transformer_invasive_st2_ops2e_onlymean_nosurgicalF.log 2>&1 &
