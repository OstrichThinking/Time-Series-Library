...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/invasive_ops2e/TimeXer_nosurgicalF_cma_sl1.py > checkpoints/invasive_ops2e/TimeXer_nosurgicalF_cma_sl1.log 2>&1 &
...
model_id = 'TimeXer_nosurgicalF_cma_sl1'
