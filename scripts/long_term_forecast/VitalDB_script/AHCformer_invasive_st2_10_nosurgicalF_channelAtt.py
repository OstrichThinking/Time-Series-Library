...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/AHCformer_invasive_st2_10_nosurgicalF_channelAtt.py > checkpoints/AHCformer_invasive_st2_10_nosurgicalF_channelAtt.log 2>&1 &
    ...
    🌞实验结果:
        ...
        |        MSE         |        MAE         |        DTW         |
        +--------------------+--------------------+--------------------+
        | 47.79935073852539  | 4.238649845123291  |   Not calculated   |
        +--------------------+--------------------+--------------------+
        模型分类性能比较:
        +--------------------+--------------------+--------------------+
        |        AUC         |      Accuracy      |       Recall       |
        +--------------------+--------------------+--------------------+
        | 0.9178082191780822 |0.36995059575704736 | 0.5273405136702568 |
        +--------------------+--------------------+--------------------+
        |     Precision      |    Specificity     |         F1         |
        +--------------------+--------------------+--------------------+
        | 0.8938431837741028 | 0.9936861344188751 | 0.6818183650879613 |
        +--------------------+--------------------+--------------------+
        混淆矩阵:
        +--------------------+--------------------+--------------------+
        |         TP         |         FN         |         --         |
...
model_id = 'AHCformer_invasive_st2_10_nosurgicalF_channelAtt'
