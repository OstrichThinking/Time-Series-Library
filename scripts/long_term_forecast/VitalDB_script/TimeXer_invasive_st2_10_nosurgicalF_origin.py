...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/TimeXer_invasive_st2_10_nosurgicalF_origin.py > checkpoints/TimeXer_invasive_st2_10_nosurgicalF_origin.log 2>&1 &
...
model_id = 'TimeXer_invasive_st2_10_nosurgicalF_origin'
