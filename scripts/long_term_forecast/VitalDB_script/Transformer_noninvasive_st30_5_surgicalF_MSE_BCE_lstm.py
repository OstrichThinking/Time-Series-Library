...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/Transformer_noninvasive_st30_5_surgicalF_MSE_BCE_lstm.py > checkpoints/output_Transformer_noninvasive_st30_5_surgicalF_MSE_BCE_lstm.log 2>&1 &
...
model_id = 'vitaldb_aaai_noninvasive_st30_5_surgicalF_A100_lstm'  
