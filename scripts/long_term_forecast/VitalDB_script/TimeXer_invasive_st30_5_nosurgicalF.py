...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/TimeXer_invasive_st30_5_nosurgicalF.py > checkpoints/TimeXer_invasive_st30_5_nosurgicalF.log 2>&1 &
...
model_id = 'TimeXer_invasive_st30_5_nosurgicalF'
