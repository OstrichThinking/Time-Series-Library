...
"""
    ...
    👋 实验后台启动命令
        nohup python -u scripts/long_term_forecast/VitalDB_script/Transformer_noninvasive_st30_5_surgicalF_MSE_BCE_alpha_permin.py > checkpoints/output_Transformer_noninvasive_st30_5_surgicalF_MSE_BCE_alpha_permin.log 2>&1 &
...
model_id = f'vitaldb_noninvasive_st30_5_surgicalF_MSE_BCE_alpha_permin'  
